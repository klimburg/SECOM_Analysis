...
```{r training_plots, echo=FALSE, dependson= 'training', warning=FALSE, fig.align='center', fig.height= 3.5, fig.width=7, fig.cap= "Figure 3: The plot shows the sensitivity from repeated cross validations of a stochastic gradient boosting model."}
